...
console.log("LCODE = " +obj.BM_LCODE + " : "+  obj.BM_BANK );
        ...
        $("#vCreaterc").click(function (e) {
            ...
            if (cuno === "none,none") {
                ...
                alert("กรุณาเลือก Customer No. หรือ  กด Search Customer");
                return;
            }
            ...
            if (confirm("Confirm to Create RCNO for '" + cuno + "'") === true) {
                ...
                if (radioValue === 'TRANSFER') {
                    var input = $("#vBKTF").val();
                    var fields = input.split(',');
                    var CHKHC_ACCODE = fields[0];
                    var CHKHC_BANK = fields[1];


                    if (CHKHC_ACCODE === null || CHKHC_BANK === null || CHKHC_ACCODE === '' || CHKHC_BANK === '') {

                        alert("Please Check Bank Transfer");
                        return;
                    }
                }
                Getrcno();
